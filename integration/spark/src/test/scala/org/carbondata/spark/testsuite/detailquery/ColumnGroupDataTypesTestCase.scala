...
class ColumnGroupDataTypesTestCase extends QueryTest with BeforeAndAfterAll {
  ...
  override def beforeAll {
    ...
    sql("LOAD DATA FACT FROM './src/test/resources/10dim_4msr.csv' INTO Cube normal partitionData(DELIMITER ',' ,QUOTECHAR '\"', FILEHEADER 'column1,column2,column3,column4,column5,column6,column7,column8,column9,column10,measure1,measure2,measure3,measure4')");
