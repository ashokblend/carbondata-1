...
class AllDataTypesTestCase1 extends QueryTest with BeforeAndAfterAll {
  ...
  override def beforeAll {
    ...
    try {
      ...
      sql("LOAD DATA LOCAL INPATH '" + currentDirectory +
          ...
          sql("LOAD DATA LOCAL INPATH '" + currentDirectory +
          "/src/test/resources/100_olap.csv' INTO table Carbon_automation_test_hive")
  ...
  test(
    ...
    checkAnswer(
      ...
      sql(
        "select series,sum(gamePointId) a from Carbon_automation_test_hive group by series order by series")
    )
  }
  )
  ...
  test(
    ...
    checkAnswer(
      ...
      sql(
        "select series,ActiveProvince,sum(gamePointId) a from Carbon_automation_test_hive group by " +
          "series,ActiveProvince order by series desc,ActiveProvince asc"
      )
    )
  }
  ...
  test(
    ...
    checkAnswer(
      ...
      sql(
        "SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from " +
          "Carbon_automation_test_hive) SUB_QRY GROUP BY AMSize, ActiveAreaId ORDER BY AMSize ASC, " +
          "ActiveAreaId ASC"
      )
    )
  }
  ...
  test(
    ...
    checkAnswer(
      ...
      sql(
        "SELECT AMSize, ActiveAreaId, SUM(gamePointId) AS Sum_gamePointId FROM (select * from " +
          "Carbon_automation_test_hive) SUB_QRY WHERE NOT(AMSize = \"\") GROUP BY AMSize, ActiveAreaId" +
          " ORDER BY AMSize ASC, ActiveAreaId ASC"
      )
    )
  }
  ...
  test(
    ...
    checkAnswer(
      ...
      sql(
        "SELECT ActiveCountry, ActiveDistrict, Activecity, SUM(gamepointid) AS Sum_gamepointid " +
          "FROM  Carbon_automation_test_hive group by ActiveCountry,ActiveDistrict,Activecity"
      )
    )
  }
  )
  ...
  test(
    ...
    checkAnswer(
      ...
      sql(
        "SELECT Latest_country, Latest_city, Latest_district, SUM(gamepointid) AS Sum_gamepointid" +
          " FROM (select * from Carbon_automation_test_hive) SUB_QRY GROUP BY Latest_country, " +
          "Latest_city, Latest_district ORDER BY Latest_country ASC, Latest_city ASC, " +
          "Latest_district ASC"
      )
    )
  ...
  test(
    ...
    checkAnswer(
      ...
      sql(
        "SELECT ActiveCountry, ActiveDistrict, Activecity, SUM(gamepointid) AS Sum_gamepointid " +
          "FROM (select * from Carbon_automation_test_hive) SUB_QRY GROUP BY ActiveCountry, " +
          "ActiveDistrict, Activecity ORDER BY ActiveCountry ASC, ActiveDistrict ASC, Activecity " +
          "ASC"
      )
    )
  ...
  test(
    ...
    checkAnswer(
      ...
      sql(
        "SELECT series, SUM(gamePointId) AS Sum_gamePointId FROM (select * from " +
          "Carbon_automation_test_hive) SUB_QRY GROUP BY series ORDER BY series ASC"
      )
    )
  }
  )
  ...
  test(
    ...
    checkAnswer(
      ...
      sql(
        "SELECT modelId, SUM(gamepointid) AS Sum_gamepointid FROM (select * from " +
          "Carbon_automation_test_hive) SUB_QRY GROUP BY modelId ORDER BY modelId ASC"
      )
    )
  }
  )
